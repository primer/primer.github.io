  ...
  <Box bg="blue.2" py={6} mt={6}>
    ...
    <Box color="black" className="container-xl p-responsive mx-auto">
      <Box mt={6} pt={4} borderTop={2} borderColor="black">
        <Text is="p">Copyright GitHub 2018. Available for use under the <LinkDark fontWeight="bold" href="https://github.com/primer/primer/blob/master/LICENSE">MIT license</LinkDark>.</Text>
